        ...
        <PageTransition>
            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
                <div className="mb-10">
                    ...
                    {/* AVISO DE SITIO EN CONSTRUCCIÓN / LISTO */}
                    {user.siteReady ? (
                        <div className="mt-6 bg-green-50 border border-green-200 rounded-xl p-6">
                            <div className="flex items-start gap-4">
                                ...
                                <div className="flex-1">
                                    <h3 className="font-bold text-green-900 text-lg">¡Tu sitio web está listo! 🚀</h3>
                                    <p className="text-green-800 mt-2">
                                        Hemos finalizado la construcción de tu página web. A continuación encontrarás los detalles para visualizarla y conectarla a tu dominio.
                                    </p>

                                    {user.provisionalUrl && (
                                        <div className="mt-4 bg-white border border-green-200 rounded-lg p-4">
                                            <p className="text-sm font-bold text-slate-500 uppercase tracking-wide mb-1">Link Provisional</p>
                                            <div className="flex items-center justify-between flex-wrap gap-2">
                                                <a href={user.provisionalUrl} target="_blank" rel="noopener noreferrer" className="text-blue-600 font-bold hover:underline break-all">
                                                    {user.provisionalUrl}
                                                </a>
                                                <a href={user.provisionalUrl} target="_blank" rel="noopener noreferrer" className="text-xs bg-blue-50 text-blue-600 px-3 py-1.5 rounded-md font-bold hover:bg-blue-100 transition-colors">
                                                    Abrir sitio
                                                </a>
                                            </div>
                                        </div>
                                    ...
                                    {user.dnsInstructions && (
                                        <div className="mt-4 bg-amber-50 border border-amber-200 rounded-lg p-4">
                                            <p className="text-sm font-bold text-amber-800 uppercase tracking-wide mb-2">Instrucciones para tu Dominio (DNS)</p>
                                            <p className="text-sm text-amber-900 whitespace-pre-wrap font-mono bg-amber-100/50 p-3 rounded-md border border-amber-200">
                                                {user.dnsInstructions}
                                            </p>
                                            <p className="text-xs text-amber-700 mt-2">
                                                * Debes configurar estos registros en tu proveedor de dominio (GoDaddy, Dreamhost, etc).
                                            </p>
                                        </div>
                                    )}
                                </div>
                        ...
                        <div className="mt-6 bg-blue-50 border border-blue-200 rounded-xl p-4 flex items-start gap-3">
                            ...
                            <div>
                                <h3 className="font-bold text-blue-900 text-sm">Tu sitio web está en construcción 🚧</h3>
                                <p className="text-sm text-blue-700 mt-1">
                                    Nuestro equipo está trabajando en tu página. Te notificaremos por correo electrónico tan pronto como esté lista para tu revisión.
                                </p>
                            </div>
                        </div>
                    )}
