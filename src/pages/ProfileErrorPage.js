    ...
    return (
        <div className="min-h-screen bg-slate-50 flex flex-col">
            ...
            <main className="flex-1 flex items-center justify-center text-center p-4">
                <div>
                    <h1 className="font-heading text-3xl font-bold text-slate-900">Error al Cargar Perfil</h1>
                    <p className="mt-2 max-w-md mx-auto text-slate-500">No pudimos encontrar tu información de usuario. Por favor, contacta a soporte.</p>
                </div>
            </main>
        </div>
    );
