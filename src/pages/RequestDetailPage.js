                        ...
                        <div className="p-4 bg-white border-t border-slate-200">
                            {request.status === 'completed' ? (
                                <div className="bg-slate-100 p-4 rounded-xl text-center">
                                    <p className="text-slate-500 text-sm font-medium">Esta solicitud ha sido completada. No se pueden enviar más mensajes.</p>
                                </div>
                            ) : (
                                <>
                                    {file && (
                                        <motion.div
                                            ...
                                            className="flex items-center gap-2 mb-2 p-2 bg-blue-50 rounded-lg border border-blue-100"
                                        >
