    ...
    return (
        <div className={`py-16 bg-${theme.bg} border-y border-slate-800`}>
            <div className="max-w-4xl mx-auto px-4 flex flex-col md:flex-row items-center justify-center gap-8">
                <div className={`w-20 h-20 rounded-full bg-slate-800 border border-slate-700 flex items-center justify-center text-white shadow-[0_0_20px_rgba(34,211,238,0.2)]`}>
