                ...
                <div className="flex justify-between h-20 items-center relative">
                    ...
                    <div className="hidden md:flex items-center space-x-8">
                        {leftLinks.map((link, index) => (
                            <a key={index} href={link.href} className="text-sm uppercase tracking-widest hover:opacity-70 transition-opacity" style={{ color: theme.text || 'slate-900' }}>
                                {link.name}
                            </a>
                        ))}
                    </div>
                    ...
                    <div className="hidden md:flex items-center space-x-8">
                        ...
                        <button
                            className="px-6 py-2 border hover:text-white transition-all uppercase tracking-widest text-xs"
                            style={{
